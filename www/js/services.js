...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://utsshooping.firebaseio.com/"),
    refCart = new Firebase("https://utsshooping.firebaseio.com/cart"),
    refUser = new Firebase("https://utsshooping.firebaseio.com/users"),
    refCategory = new Firebase("https://utsshooping.firebaseio.com/category"),
    refOrder = new Firebase("https://utsshooping.firebaseio.com/orders"),
    refMenu = new Firebase("https://utsshooping.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
